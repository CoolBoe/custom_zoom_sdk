...
class ProductServices{
  ...
  Future<List<ProductModel>>getProductByBrand({String sort, String page, String per_page, String brand}) => WebApiServices().getProductByBrand(sort,page, per_page, brand ).then((data){
    if(data.statusCode==HTTP_CODE_200){
  ...
  Future<List<ProductModel>>getProductByFeatured({String sort, String page, String per_page, String featured}) =>
  ...
  Future<List<ProductModel>>getProductByOnSale({String sort, String page, String per_page, String on_sale}) =>
