...
class ShopState extends State<ShopView> {
      ...
      child: GestureDetector(
        onTap: () {
          ...
          if (sort != null) {
            ...
            productProvider.loadProductsBySorting(
                sort: sort, page: page, per_page: per_page);
          }
          ;
          if (min_price != null || max_price != null) {
            printLog("pricecheck", min_price.toString());
            productProvider.loadProductsByPrice(
                sort: sort,
                page: page,
                per_page: per_page,
                min_price: min_price,
          ...
          if (on_sale != null) {
            ...
            productProvider.loadProductsByOnSale(
                sort: sort, page: page, per_page: per_page, on_sale: on_sale);
          }
          if (brand != null) {
            printLog("brandcheck", brand.toString());
            productProvider.loadProductsByBrand(
                sort: sort, page: page, per_page: per_page, brand: brand);
          }
          if (featured != null) {
            printLog("featuredcheck", featured.toString());
            productProvider.loadProductsByFeatured(
                sort: sort, page: page, per_page: per_page, featured: featured);
          }
  ...
  Widget SliverDataBuilder() {
          ...
          return GestureDetector(
            onTap: () async {
              changeScreen(context,
                  ProductScreen(productModel: productList(context)[index]));
            },
            child: Container(
              height: 200,
              ...
              child: Column(
                children: <Widget>[
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: FadeInImage(
                          ...
                          image: NetworkImage(productList(context).length >= 0
                              ? productList(context)[index].images[0].src
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(
                                    top: 3.0, left: 5, bottom: 3, right: 5),
                                child: Text(
                                  productList(context).length > 0
                  ...
                  Padding(
                    ...
                    child: Text(
                      productList(context).length >= 0
                          ? productList(context)[index].name
                          : "Woo App",
                      style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Poppins',
                    ...
                    children: [
                      new RichText(
                        text: new TextSpan(
                          ...
                          children: <TextSpan>[
                            new TextSpan(
                              text: productList(context).length >= 0
                                  ? "₹ " +
                                      productList(context)[index].price +
                                      "   "
                                  : "₹ 200 ",
                              style: TextStyle(
                                color: Colors.black,
                            ...
                            new TextSpan(
                              text: productList(context).length >= 0
                                  ? "₹" +
                                      productList(context)[index].regularPrice
                                  : "₹ 250",
                              style: TextStyle(
                                color: Colors.black,
                                fontFamily: 'Poppins',
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        productList(context).length >= 0
                            ? " {" +
                                productList(context)[index].averageRating +
                                "}"
                            : "5",
                        style: TextStyle(
                          color: Colors.black,
    ...
    if (productList(context).length != null) {
      return SliverPadding(padding: EdgeInsets.all(8), sliver: grid);
    } else {
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      height: 200,
                      child: Expanded(child: sortByDialog(sortByIndex)),
                    ),
                    _sortingbutton()
                  ],
                ),
