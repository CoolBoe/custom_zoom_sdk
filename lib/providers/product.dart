...
class ProductsProvider with ChangeNotifier {
  ...
  ProductsProvider.initialize() {
    loadProducts(
        sort: WebRequestConstants.SORT_BY_DEFAULT, per_page: "10", page: "1");
  }

  Future<List<ProductModel>> loadProducts(
          {String sort, String page, String per_page}) =>
      WebApiServices().getProducts(sort, page, per_page).then((data) {
  ...
  Future<List<ProductModel>> loadProductsByPrice(
          {String sort,
          String page,
          String per_page,
          String min_price,
  ...
  Future<List<ProductModel>> loadProductsByBrand(
  ...
  Future<List<ProductModel>> loadProductsByFeatured(
  ...
  Future<List<ProductModel>> loadProductsByOnSale(
  ...
  Future<List<ProductModel>> getProductBySearch(
          {String sort, String page, String per_page, String search}) =>
      WebApiServices()
          .getProductBySearch(sort, page, per_page, search)
          .then((data) {
        if (data.statusCode == HTTP_CODE_200) {
  ...
  Future loadProductsBySorting(
      {String sort, String page, String per_page}) async {
    productsByCategory = await _productServices.getProductBySearch(
