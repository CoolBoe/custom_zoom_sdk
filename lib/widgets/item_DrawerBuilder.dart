                ...
                child: Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color:  _selectItem==index ? Colors.orange: Colors.transparent,
                      ...
                      child: Row(
                        children: <Widget>[
                          Padding(
                            ...
                            child: SvgPicture.asset(sortBy[index].icon,width: 20,height: 20, color: _selectItem==index ? Colors.white: Colors.black,),
                          ),
                          Text(sortBy[index].name, style: TextStyle(
                              color: _selectItem==index ? Colors.white: Colors.black,
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Padding(
                              padding: EdgeInsets.only(left: 00, top: 10, right: 00),
                              child: Container(
                                  width: 150,
                                  color: Colors.transparent,
                                  child: Padding(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Center(
                                          child: Text('Not Really', style: TextStyle(
                                              color: Colors.white,
                                              fontFamily: 'Poppins', fontWeight: FontWeight.w400, fontSize: 12)),
                                        ),
                                      ),
