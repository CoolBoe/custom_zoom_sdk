...
class _BannerSliderState extends State<BannerSlider> {
  ...
  Widget build(BuildContext context) {
    return Container(
        child:Column(
           children: [
            topBanner!=null && topBanner.banner.length>0 ? Container(
              width: double.infinity,
              height: 100, child: CarouselSlider(
                ...
                return Builder(
                  builder: (BuildContext context){
                    return Container(
                        ...
                        decoration: BoxDecoration(color: grey_200,),
                        child: GestureDetector(
                            child: Image.network(e.bannerUrl, fit: BoxFit.cover),
                            onTap: () {
                              if(e.bannerType=="category"){
                                changeScreen(context, ShopView(categoryId: e.connectId,));
            ...
            Container(
             ...
             secondaryBanner!=null && secondaryBanner.banner.length>0 ? Container(
  ...
  Widget layoutType1(SectionBanner sectionBanner, BuildContext context){
    return Container(
        ...
        child: Column(
          children: [
            Text(sectionBanner.title, style: styleProvider(size: 12, color: Colors.black, fontWeight: semiBold),),
            SizedBox(height: 5,),
            GestureDetector(
                child: FadeInImage.assetNetwork(placeholder: ic_thumbnail_png, height: 30, width: 30, image: sectionBanner.banner[0].bannerUrl,fit: BoxFit.cover),
                onTap: () {
                  if(sectionBanner.banner[0].bannerType=="category"){
                    changeScreen(context, ShopView(categoryId: sectionBanner.banner[0].connectId,));
                  }else if (sectionBanner.banner[0].bannerType=="page"){
                    product.fetchProductByPageId(page_id: sectionBanner.banner[0].connectId);
                  }
                }),
          ],
        ));
              ...
              child:  Row(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: FadeInImage.assetNetwork(placeholder: ic_thumbnail_png, image: sectionBanner.banner[0].bannerUrl,fit: BoxFit.cover),
                  ),
                  GestureDetector(
                    onTap: (){
                      if(sectionBanner.banner[1].bannerType=="category"){
                        ...
                        var product = Provider.of<ProductsProvider>(context, listen: false);
                        product.fetchProductByPageId(page_id: sectionBanner.banner[1].connectId);
                      }
                    },
                    child: FadeInImage.assetNetwork(placeholder: ic_thumbnail_png, image: sectionBanner.banner[1].bannerUrl,fit: BoxFit.cover),
                  )
                ],
              ),
            )
                ...
                children: [
                  GestureDetector(
                      ...
                      child: Container(
                        height: 170,
                        width: 200,
                        child: FadeInImage.assetNetwork(placeholder: ic_thumbnail_png, image: sectionBanner.banner[0].bannerUrl,fit: BoxFit.fill),
                      )
                  ),
                  Container(
                    child: Column(
                      ...
                      children: [
                        GestureDetector(
                            ...
                            child: Container(
                              height: 80,
                              width: 140,
                              child: FadeInImage.assetNetwork(placeholder: ic_thumbnail_png, image: sectionBanner.banner[1].bannerUrl,fit: BoxFit.fill),
                            )
                        ),
                        GestureDetector(
                            onTap: (){
                              if(sectionBanner.banner[2].bannerType=="category"){
                                changeScreen(context, ShopView(categoryId: sectionBanner.banner[0].connectId,));
                              }else if (sectionBanner.banner[2].bannerType=="page"){
                                var product = Provider.of<ProductsProvider>(context, listen: false);
                                product.fetchProductByPageId(page_id: sectionBanner.banner[2].connectId);
                              }
                            },
                            child: Container(
                              height: 80,
              ...
              children: sectionBanner.banner.map((e){
                return GestureDetector(onTap: (){
                  if(e.bannerType=="category"){
                    ...
                    child: FadeInImage.assetNetwork(placeholder: ic_thumbnail_png, image: e.bannerUrl,fit: BoxFit.fill));
              }).toList()  ,
            ),)
        ],
      ),
